<div class="list-group">
    <a href="{{ url('/barang') }}" class="list-group-item list-group-item-action">Barang</a>
    <a href="{{ url('/satuan') }}" class="list-group-item list-group-item-action">Satuan</a>
    <a href="{{ url('/vendor') }}" class="list-group-item list-group-item-action">Vendor</a>
    <a href="{{ url('/role') }}" class="list-group-item list-group-item-action">Role</a>
    <a href="{{ url('/user') }}" class="list-group-item list-group-item-action">User</a>
